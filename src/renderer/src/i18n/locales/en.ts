const en = {
  ...
  skills: {
    builtin: "Built-in",
    builtinDescription: "Ships with WorkLens; enable or disable each one.",
    universal: "Universal agent skills",
    universalDescription:
      "From ~/.agents/skills, shared with other agent tools on this machine. WorkLens only reads this folder and never writes to it.",
    refreshSkills: "Rescan the skills directories",
    noBuiltinSkills: "No built-in skills yet.",
    noUniversalSkills: "No skills found in ~/.agents/skills.",
    enableSkill: "Enable skill: {{skill}}",
    toggleFailed: "Could not update the skill",
    refreshFailed: "Could not refresh skills",
