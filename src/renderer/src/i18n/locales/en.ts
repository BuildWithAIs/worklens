const en = {
  ...
  settingsFeedback: {
    ...
    visibilityFailed: "Couldn’t save model selection",
  ...
  settings: {
    ...
    selectMatchingModels: "Select results",
    clearMatchingModels: "Deselect results",
    modelSelectionRetry: "Your changes are kept. Try saving again.",
    modelRefreshRetry: "Your choices are kept. Try refreshing again.",
    modelCatalogUnavailable:
      "This provider is no longer available. Check its connection in Providers.",
    newModel: "New",
